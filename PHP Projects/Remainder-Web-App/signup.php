...
<body>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100 loginContent">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 formContainer">
                    <form action="connection.php" method="post">
                        ...
                        <div class="form-outline mb-4 ">
                            <input id="mailid" name="mailId" type="email"  class="form-control form-control-lg inputContainer"
                                placeholder="Mail ID" required />
                        </div>

                        <div class="form-outline mb-4 ">
                            <input id="phnumber" name="phNumber" type="number"  class="form-control form-control-lg inputContainer"
                                placeholder="Phone Number" required />
                        </div>

                        <div class="form-outline mb-3">
                            <input name="password" type="password" id="password"
                                class="form-control form-control-lg inputContainer" placeholder="Enter password"
                                required />
                        </div>

                        <div class="form-outline mb-3 ">
                            <input name="passwordCheck" type="password" id="repassword"
                                class="form-control form-control-lg inputContainer" placeholder="Re-Enter password"
                                required />
                        </div>

                        <div class="text-center text-lg-start mt-4 pt-2">
                            <p class="small fw-bold mt-2 pt-1 mb-0">
                                <span class="loginSignupTxt">Already have an account?</span>
                                <a href="./index.php"><span class="loginSignUp">Sign Up</span></a>
                            </p>
                        </div>
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2 loginBtnContainer">
                            ...
                            <!--<button class="noselect loginBtn" onclick="popUp('signup')">
                                <span class="text" id="loginSignUpBtn">Sign Up</span>
                                <span class="icon">
    ...
    <div class="alertContainer popUpContainer" id="successPopUp">
        <div class="alert">
            ...
            <div class="alertSymbol">
                <img src="./assests/greenTickImg.webp" alt="">
            </div>
    ...
    <div class="alertContainer popUpContainer" id="cancelPopUp">
        <div class="alert">
            ...
            <div class="alertSymbol">
                <img src="./assests/redCrossImg.png" alt="">
            </div>
