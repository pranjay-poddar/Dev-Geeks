<h2 align="center">Documentation on Github user search project</h2>
<p>You can type user name on the website & it will show the profile of the user along with their repositories & other relevant informations.The GitHub ID is basically the ID for your username, nothing else.</p>
