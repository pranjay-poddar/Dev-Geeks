...
tippy('.profile', {
	content: '<b>Google Account</b><br>Rohan mittal<br>rohanmittal525@gmail.com',
	placement: 'bottom',
	arrows: false,
	animation: 'fade',
	theme: 'light',
...
document.querySelector('.upper').innerHTML = outputUpper;
document.querySelector('.middle').innerHTML = outputMiddle;

$(document).ready(function () {
	$('#apps').click(function () {
		$('.account').fadeOut();
		$('.apps_dropdown').fadeToggle();
	});

	$('.profile').click(function () {
		$('.apps_dropdown').fadeOut();
		$('.account').fadeToggle();
	});
});
