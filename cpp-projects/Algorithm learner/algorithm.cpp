...
int main()
{
    ...
    if (choice == 1)
    {
        ...
        else if (choice1 == 2)
        {
            ...
            cout << "DESCRIPTION" << endl;
            cout << "-----------------------------" << endl;
            cout << "The algorithm repeatedly selects the smallest (or largest) element from the unsorted portion of the list and\nswaps it with the first element of the unsorted part.\nThis process is repeated for the remaining unsorted portion until the entire list is sorted. " << endl;
            cout << "-----------------------------" << endl;
            cout << "TIME COMPLEXITY" << endl;
            cout << "-----------------------------" << endl;
            cout << "The time complexity of the Selection Sort algorithm is O(n^2), where n is the number of elements in the array\nto be sorted" << endl;
            cout << "-----------------------------" << endl;
            cout << "Enter size of array" << endl;
            int n;
            cin >> n;
