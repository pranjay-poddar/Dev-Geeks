...
function Stuck() {
    ...
    if (onboard[currpawn] == 0||currPos+num>44) {
        if (DontHaveOtherFree()||currPos+num>44) {
            ...
            dice.style.backgroundImage = "url(https://i.ibb.co/wB44dCd/dice.gif)";
...
function randomNum() {
    if (!clicked) {
        var imageLinks = [
          "https://i.ibb.co/1m4qHFf/3.jpg",
          "https://i.ibb.co/drs0d37/4.jpg",
          "https://i.ibb.co/bH1L0tX/5.jpg",
          "https://i.ibb.co/q1F3B1v/6.jpg",
          "https://i.ibb.co/Sf8cwVt/1.jpg",
          "https://i.ibb.co/BwjQygb/2.jpg",
        ];
    
        var num = Math.floor(Math.random() * imageLinks.length);
        var dice = document.getElementById('dice');
        dice.style.backgroundImage = "url(" + imageLinks[num] + ")";
        clicked = true;
    }
