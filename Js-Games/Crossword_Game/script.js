...
bgMusic.src = 'https://drive.google.com/uc?export=download&id=1HnDYe1i9nt3C9UsI9mbyLKxc_ooHSCIp';
bgMusic.volume = 0.4;

const backSpace = new Audio();
backSpace.src = 'https://drive.google.com/uc?export=download&id=1DNsm6xFJNr8F3MQBUHwhh6QSZPrdvYmC';

const rightAnswer = new Audio();
rightAnswer.src = 'https://drive.google.com/uc?export=download&id=1Fkdtf2yFamMLN7-CRxKxQn-72RbEXq50';

const wrongAnswer = new Audio();
wrongAnswer.src = 'https://drive.google.com/uc?export=download&id=1hHCOGhqMBXc0k7Zi14ubxAP9p8YyWJ3U';

const win = new Audio();
win.src = 'https://drive.google.com/uc?export=download&id=1CdD24A1alWWS8rWe27Sy2OoFnH5VAAHR';

const gameOver = new Audio();
gameOver.src = 'https://drive.google.com/uc?export=download&id=1KraLQ0KXASkgKd0mGm9P0N85PJSt_5xA';

const keyPress = new Audio();
keyPress.src = 'https://drive.google.com/uc?export=download&id=1dKgdNYqfdFVCtMZZ4mVIEKjujXbQO46r';
